const menuBars = document.getElementById("menu-bars")! as HTMLElement;
const overlay = document.getElementById("overlay")! as HTMLElement;
const nav1 = document.getElementById("nav-1")! as HTMLElement;
const nav2 = document.getElementById("nav-2")! as HTMLElement;
const nav3 = document.getElementById("nav-3")! as HTMLElement;
const nav4 = document.getElementById("nav-4")! as HTMLElement;
const nav5 = document.getElementById("nav-5")! as HTMLElement;
